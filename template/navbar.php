<body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="<?= $main_url ?>index.php">Inventarisasi Aset Dinas PMD Kalsel</a>
            <!-- Sidebar Toggle-->
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="<?= $main_url ?>dinas/profiledinas.php">Profile Dinas</a></li>
                        <li>
                            <hr class="dropdown-divider" />
                        </li>
                        <li><a class="dropdown-item" href="<?= $main_url ?>authh/logout.php">Logout</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
  ...
  <div class="row g-0">
    <div class="col-md-4">
      <img src="<?= $main_url ?>asset/img/<?= $profile['foto'] ?>" class="img-fluid rounded-start" width="100%" alt="gambar user">
    </div>
    <div class="col-md-8">
      <div class="card-body">
