...
<html lang="en">
    ...
    <head>
        ...
        <title>Login - Inventarisasi Aset Dinas PMD Kalsel</title>
        <link href="<?= $main_url ?>asset/sb_admin/css/styles.css" rel="stylesheet" />
        <script src="https://use.fontawesome.com/releases/v6.3.0/js/all.js" crossorigin="anonymous"></script>
        <link rel="icon" type="image/x-icon" href="<?= $main_url ?>asset/img/ff.jpeg">
        
        <style>
            #bgLogin{
                background-image: url("../asset/img/<?= $data['gambar'] ?>");
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h4 class="text-center font-weight-light my-4">Login - Inventarisasi Aset Dinas PMD Kalsel</h4></div>
                                    <div class="card-body">
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="text-muted small">Copyright &copy; Dinas PMD Kalsel <?= date("Y") ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
