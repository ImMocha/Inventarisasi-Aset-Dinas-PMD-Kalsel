    ...
    <div class="container-fluid px-4">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <a href="<?= $main_url ?>pegawaiii/addpegawaiii.php" class="btn btn-sm btn-primary float-end ms-2"><i
              class="fa-solid fa-plus"></i> Tambah Pegawai</a>
        </div>
        <div class="card-body">
            ...
            <tbody>
              ...
              while ($data = mysqli_fetch_array($queryPegawai)) {
                ...
                <tr>
                  ...
                  <td><?= $data['telepon'] ?></td>
                  <td align="center">
                    <a href="editpegawaiii.php?id=<?= $data['id'] ?>" class="btn btn-sm btn-warning"
                      title="update pegawai"><i class="fa-solid fa-pen"></i></a>
                    <button type="button" class="btn btn-sm btn-danger" id="btnHapus" title="hapus pegawai"
                      data-id="<?= $data['id'] ?>"><i class="fa-solid fa-trash"></i></button>
                  </td>
                </tr>
              <?php } ?>
            </tbody>
  ...
  <script>
    $(document).ready(function () {
      $(document).on('click', "#btnHapus", function () {
        ...
        $('#btnMdlHapus').attr("href", "hapuspegawaiii.php?id=" + idPegawai);
      })
    })
  </script>
