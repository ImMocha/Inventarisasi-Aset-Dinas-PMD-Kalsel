...
class PDF extends FPDF
{
    function Header()
    {
        ...
        $this->Cell(200, 8, 'DATA PEMELIHARAAN ASET', 0, 1, 'C');
...
while ($data = mysqli_fetch_array($query)) {
    ...
    $pdf->Cell(10, 10, $no, 1, 0, 'C');
    $pdf->Cell(50, 10, $data['aset'], 1, 0, 'L');
    $pdf->Cell(35, 10, $data['kondisi'], 1, 0, 'L');
    $pdf->Cell(45, 10, $data['keterangan'], 1, 0, 'L');
    $pdf->Cell(45, 10, $data['pemeliharaan'], 1, 1, 'L');
    $no++;
}

$pdf->Output('I', 'Daftar_Pemeliharaan_Aset.pdf');
?>