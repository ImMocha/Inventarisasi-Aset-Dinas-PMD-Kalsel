...
<head>
  ...
  <title>Laporan Hasil Aset Yang Digunakan Pegawai</title>
</head>

<body>

<div style="text-align: center;">
  <h2 style="margin-bottom: -15px;">Laporan Hasil Aset Yang Digunakan Pegawai</h2>
...
<table>
  ...
  <tbody>
    <?php
    $dataRuangan = mysqli_query($koneksi, "SELECT * FROM tbl_pgwrn");
    while ($data = mysqli_fetch_array($dataRuangan)) { ?>
      <tr>
        <td align="center"><?= $data['id'] ?></td>
        <td align="center"><?= $data['ruangan'] ?></td>
