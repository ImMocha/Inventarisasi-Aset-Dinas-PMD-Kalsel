...
<head>
  ...
  <title>Laporan Hasil Kondisi Aset</title>
</head>

<body>

<div style="text-align: center;">
  <h2 style="margin-bottom: -15px;">Laporan Hasil Kondisi Aset Barang</h2>
...
<table>
  ...
  <tbody>
    <?php
    $dataJenis = mysqli_query($koneksi, "SELECT * FROM tbl_jenkon");
    while ($data = mysqli_fetch_array($dataJenis)) { ?>
      <tr>
